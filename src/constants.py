...
IMAGES = {
    ...
    "furnace_on": Img("structureFurnaceOn.png"),

    "launcher": Img("structureLauncher.png", collides=True, destroy=[15, "package"],
    ...
    "battery_factory_on": Img("structureBatteryOn.png"),

    # Packages
    "endless_package": Img("structurePackageGenPackage.png", color_code=(0, 255, 0), placeable=True),
